...
void Light::lightSet(LPDIRECT3DDEVICE9 pD3DDevice)
{
	...
	//MyDirect3D_GetDevice()->SetRenderState(D3DRS_DIFFUSEMATERIALSOURCE, D3DMCS_MATERIAL);
	...
	//MyDirect3D_GetDevice()->SetRenderState(D3DRS_AMBIENTMATERIALSOURCE, D3DMCS_MATERIAL);
